...
app.use(
  helmet({
    contentSecurityPolicy: {
      directives: {
        defaultSrc: ["'self'"],
        // Allow inline/nonce for swagger UI + trusted cdn for assets
        scriptSrc: ["'self'", (req: any) => `'nonce-${req.cspNonce}'`, "https://cdn.jsdelivr.net", "'unsafe-inline'"],
        styleSrc: ["'self'", (req: any) => `'nonce-${req.cspNonce}'`, "https://cdn.jsdelivr.net", "'unsafe-inline'"],
        imgSrc: ["'self'", "data:", "https:"],
        fontSrc: ["'self'", "https://fonts.googleapis.com", "https://fonts.gstatic.com"],
        connectSrc: ["'self'", "https://api.stellar.org", "https://www.google-analytics.com", "https://analytics.google.com"],
        frameSrc: ["'self'"],
        objectSrc: ["'none'"],
        mediaSrc: ["'self'"],
        childSrc: ["'self'"],
