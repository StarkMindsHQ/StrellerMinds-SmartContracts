...
impl AdvancedSearchContract {
    ...
    pub fn get_content_analysis(env: Env, content_id: String) -> Result<ContentAnalysis, Error> {
        Self::require_initialized(&env)?;

        ContentAnalyzer::get_analysis(&env, content_id).ok_or(Error::ContentNotFound)
    }

    /// Find content by tag
    pub fn find_by_tag(env: Env, tag: String) -> Result<Vec<String>, Error> {
        Self::require_initialized(&env)?;
    ...
    pub fn find_by_skill(env: Env, skill_name: String) -> Result<Vec<String>, Error> {
        Self::require_initialized(&env)?;
    ...
    /// Search by color
    pub fn find_by_color(env: Env, color_hex: String) -> Result<Vec<String>, Error> {
        Self::require_initialized(&env)?;
    ...
    pub fn find_by_object(env: Env, object_type: String) -> Result<Vec<String>, Error> {
        Self::require_initialized(&env)?;
    ...
    pub fn get_learning_path(env: Env, user: Address) -> Result<LearningPath, Error> {
        Self::require_initialized(&env)?;
        user.require_auth();

        LearningPathOptimizer::get_learning_path(&env, user).ok_or(Error::ContentNotFound)
    }
    ...
    pub fn get_next_step(env: Env, user: Address) -> Result<PathStep, Error> {
        Self::require_initialized(&env)?;
        user.require_auth();

        LearningPathOptimizer::get_next_step(&env, user).ok_or(Error::ContentNotFound)
    }
    ...
    pub fn create_conversation_session(env: Env, user: Address) -> Result<String, Error> {
        Self::require_initialized(&env)?;
        user.require_auth();
    ...
    pub fn get_conversation_session(
        ...
        VoiceSearch::get_conversation_session(&env, session_id).ok_or(Error::SessionExpired)
    }

    /// End conversation session
    pub fn end_conversation_session(env: Env, user: Address) -> Result<(), Error> {
        Self::require_initialized(&env)?;
        user.require_auth();
    ...
    pub fn authorize_oracle(env: Env, admin: Address, oracle: Address) -> Result<(), Error> {
        Self::require_initialized(&env)?;
        Self::require_admin(&env, &admin)?;
    ...
    pub fn revoke_oracle(env: Env, admin: Address, oracle: Address) -> Result<(), Error> {
        Self::require_initialized(&env)?;
        Self::require_admin(&env, &admin)?;
